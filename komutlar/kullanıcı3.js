  ...
  if (!params[0]) {
	...
	message.channel.send({embed: {
            ...
            fields: [
                ...
                value: prefix + "**sürümNotları** `-" + " Wolfy Sürümü Hakkında Bilgi Verir`" + "\n" + prefix + "**sunucuBilgisi** `-" + " Sunucunuzun Bilgisini Gösterir`" + "\n" + prefix + "**destekSunucusu** `-" + " Destek Sunucusunun Davet Linkini Özelden Atar`" + "\n" + prefix + "**hizmetlerimiz** `-" + " Wolfy'nin Kaç Sunucuya Hizmet Verdiğini Gösterir`" + "\n" + prefix + "**botYapımcısı** `-" + " Wolfy'nin Yapımcısı Hakkında Bilgi Verir`",
				}
			  ],
			timestamp: new Date(),
            footer: {
